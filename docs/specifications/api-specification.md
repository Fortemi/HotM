...
router. HotM does not advertise or expose the historical POST/DELETE routes.
Read-only graph exploration remains available; semantic and wiki links are
generated by Fortemi-owned maintenance rather than a user-authored mutation.
