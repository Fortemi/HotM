# SOP: Governance & Cadence

## Cadences
- Weekly triage: review new issues, assign owners (per CODEOWNERS), update priorities.
- Bi-weekly planning: set sprint scope from roadmap; confirm acceptance criteria.
- Monthly release review: alpha/beta quality, open risks, and readiness.
