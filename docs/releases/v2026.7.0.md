...
checksum files. The GitHub mirror is not release-equivalent because its
`v2026.7.0` tag resolves to an older commit; correction and asset mirroring are
tracked in HotM issue #274.
