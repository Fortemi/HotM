...
DMG drop-in replace. If this is your first install of a self-signed HotM build, follow the Gatekeeper approval flow in [`docs/installation/desktop-macos.md`](../installation/desktop-macos.md).
