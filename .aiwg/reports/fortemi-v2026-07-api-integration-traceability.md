...
| FORTEMI-2026-07-REQ-015 | Revision-19 `core-v1` migration receipt is preserved; revision-20 exact `2.0.0/full-v1` adds 33/34 inventory checks, pass-through sidecar streaming, mandatory signed dry-run, five zero-mutation rejection classes, and pinned runtime/paired clean-destination evidence. The live HotM cell stopped before mutation because the production export was unsigned. | Fortemi #1088 blocks the passing HotM cell. Keep `fullV1Interoperability=false`, `suiteWide=false`, `completeBackup=false`, and `record-v1` unsupported. |
