...
|---|---|
| OP-2026-07-001 accept tenant-admin persona? | Pending |
| OP-2026-07-002 accept local sidecar plus hosted preview metadata target? | Pending |
| OP-2026-07-003 accept compatibility-first demo order? | Pending |
| OP-2026-07-004 accept fixture-backed preview claim boundary? | Pending |
| OP-2026-07-005 accept HUX-REQ-010 live CI caveat as an open gate? | Pending |
| OP-2026-07-006 accept private registry as a hard blocker until publish/consume proof? | Pending |
| Operator name / handle | Pending |
| Decision date | Pending |
| Notes or required changes | Pending |
