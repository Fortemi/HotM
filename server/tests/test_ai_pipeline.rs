#[cfg(test)]
mod tests {
    use hotm_server::db::{AppState, insert_note, fetch_note};
    use uuid::Uuid;
    ...
    async fn test_ai_revision_generation() {
        ...
        // Create a test note
        let test_content = "This is a test note for AI revision testing. It should be enhanced with markdown.";
        ...
        assert_eq!(note_full.original.content, test_content, "Original content should be preserved");
        ...
        if let Some(revised) = &note_full.revised {
            ...
            assert_ne!(revised.content, test_content, "Revised content should be different from original");
            ...
            let has_markdown = revised.content.contains("#") || 
                              ...
                              revised.content.contains("*") ||
                              revised.content.contains("-");
            assert!(has_markdown, "AI revision should contain markdown formatting");
        } else {
    ...
    async fn test_embedding_generation() {
        ...
        assert!(embeddings.count.unwrap_or(0) > 0, "Embeddings should be generated for the note");
    }
}