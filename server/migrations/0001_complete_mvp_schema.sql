-- Hall of the Mind MVP Schema - Complete Initial Deployment
-- This migration creates the complete schema for HotM v0.1.0
...
CREATE TYPE job_type AS ENUM ('ai_revision', 'embedding', 'linking', 'context_update');
